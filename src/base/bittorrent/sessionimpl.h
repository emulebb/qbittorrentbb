...
namespace BitTorrent
{
    ...
    public:
        ...
        void setAutoBanBTPlayerPeerEnabled(bool value) override;
        bool isShadowBanEnabled() const override;
        void setShadowBanEnabled(bool value) override;
        bool isAutoBanUnknownEverywhereEnabled() const override;
        void setAutoBanUnknownEverywhereEnabled(bool value) override;
        QStringList autoBanUnknownCountries() const override;
    ...
    private:
        ...
        CachedSettingValue<bool> m_isAutoBanUnknownEverywhereEnabled;
        CachedSettingValue<QStringList> m_autoBanUnknownCountries;
        CachedSettingValue<QStringList> m_autoBanBlockedCountries;
